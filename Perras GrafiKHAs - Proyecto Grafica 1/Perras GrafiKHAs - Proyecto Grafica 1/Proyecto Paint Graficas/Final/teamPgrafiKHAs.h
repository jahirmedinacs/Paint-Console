#ifndef TEAMPGRAFIKHAS_H_INCLUDED
#define TEAMPGRAFIKHAS_H_INCLUDED
...
void regularPolygonPlot(vector< pair<double,double> > coordinates , bool paint,  color colorDataBoundaries,color colorDataFill)
{   
...
#endif // TEAMPGRAFIKHAS_H_INCLUDED
