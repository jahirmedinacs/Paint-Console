...
void regularPolygonPlot(vector< pair<double,double> > coordinates , bool paint)
{   
...
/************* FILLED **************/
    ...
    {   
        ...
        for(int i=0; i<vertexContainer.size(); i++)
        {
            cout<<endl<<"\t\t"<<equis.size()<<"\t"<<auxiliarYCordinates.size()<<endl;
